...
zw1 = zw;   % a copy of the original signal
zw1(64:end) = 0; % discard 75%
...
% TODO 6
% Analysis of wavelet coefficients (optional if you have time)

% create a copy of the wavelet decomposed image
denoise_image = w_image;

% example solution I: discard detail quadrants
% denoise_image(65:end,65:end)  = 0;
% denoise_image(1:64,64:end)    = 0;
% denoise_image(65:end,1:64)    = 0;

% example solution II: threshold the wavelet coefficients
...
for j = 0:7
    ...
    denoise_image(1:2^(j+1),1:2^(j+1)) = tmp; % this a clever in place replacement of data, it is written to the same variable but a different section of the image
end
